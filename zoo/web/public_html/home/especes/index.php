...
<body>
    ...
    <a href="ajouter.php" style="display:inline-block; margin-bottom:15px; padding:8px 12px; background:#4CAF50; color:white; text-decoration:none;">+ Ajouter une espèce</a>
        ...
        <tbody>
            <?php foreach($especes as $esp): ?>
                <tr>
                    ...
                    <td>
                        <?php echo ($esp['EST_MENACE'] == 1) ? '<span style="color:red;">Menacée</span>' : 'Classique'; ?>
                    </td>
                    <td>
